...
func primaryOpcode32(curByte int, isOperandSizeOverride bool) Instruction {
	switch curByte {
	case 0x0, 0x1, 0x2, 0x3, 0x4, 0x5:
		return ADD
	case 0x6, 0xE, 0x16, 0x1E, 0x50, 0x51, 0x52, 0x53, 0x54, 0x55, 0x56, 0x57, 0x58, 0x59, 0x5A, 0x5B, 0x5C, 0x5D, 0x5E, 0x5F, 0x68, 0x6A:
		return PUSH
	case 0x7, 0x17, 0x1F:
		return POP
...
func primaryOpcode64(curByte int) Instruction {
	switch curByte {
	case 0x0, 0x1, 0x2, 0x3, 0x4, 0x5:
		return ADD
	case 0x6, 0xE, 0x16, 0x1E, 0x50, 0x51, 0x52, 0x53, 0x54, 0x55, 0x56, 0x57, 0x58, 0x59, 0x5A, 0x5B, 0x5C, 0x5D, 0x5E, 0x5F, 0x68, 0x6A:
		return PUSH
	case 0x7, 0x17, 0x18, 0x19, 0x1A, 0x1B, 0x1C, 0x1D, 0x1F:
		return POP
	case 0x8, 0x9, 0xA, 0xB, 0xC, 0xD:
		return OR
	case 0xF:
